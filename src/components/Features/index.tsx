  ...
  return (
    <section className="bg-primary-WHITE pb-8 pt-5 lg:pb-[70px]">
      <div
        ...
        data-wow-delay=".2s"
      >
        <h1 className="mb-4 mt-16 text-2xl font-extrabold uppercase leading-tight text-secondary-GRAY sm:mb-6 sm:mt-20 sm:text-xl md:text-2xl lg:mb-6 lg:mt-20 lg:text-2xl lg:leading-snug xl:text-3xl xl:leading-snug 2xl:text-4xl 2xl:leading-[1.2]">
          GET A FREE <span className="text-accent-BLUE">AI RECEPTIONIST</span>
        </h1>
        <p className="mx-auto mb-6 max-w-[450px] px-1 font-light leading-relaxed text-secondary-LIGHT_GRAY sm:-mt-3 sm:mb-9 sm:max-w-[500px] sm:text-base sm:leading-[1.44] md:max-w-[600px] md:text-base md:leading-[1.44] lg:-mt-3 lg:mb-9 lg:max-w-[600px] lg:text-base lg:leading-[1.44]">
          ...
          that you can use for Free until it starts making you money. If no
          results = no cost.
        </p>
      </div>
