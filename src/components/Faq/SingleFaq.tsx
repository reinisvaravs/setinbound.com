      ...
      <div className="mb-4 lg:mb-6">
        ...
        >
          <span className="flex items-center">
            <span className="mr-4 flex h-[32px] w-[32px] items-center justify-center rounded-xl bg-transparent text-secondary-GRAY sm:mr-6">
              <svg
                width="28"
                height="28"
                viewBox="0 0 34 34"
            ...
            <span className="text-xl font-semibold text-secondary-GRAY sm:text-2xl lg:text-xl xl:text-2xl">
              {question}
            </span>
          </span>
          <span
            className={`ml-2 text-secondary-LIGHT_GRAY transition-transform duration-200 ${open ? "rotate-180 opacity-100" : "rotate-0 opacity-50"}`}
          >
            ▼
          </span>
        </button>
